...
local ordereddict = require('CopilotChat.utils.ordereddict')
...
---@return OrderedDict<string, CopilotChat.config.providers.Provider>
function Client:get_providers(supported_method)
  local out = ordereddict()
